...
import { NotifyConfig, NotifyController, NotifyType, Position } from '../../services/notify-controller.service';
    ...
    ngOnInit() {
        this.notifyService.notify$.subscribe((config: NotifyConfig) => {
            ...
            switch (config.position) {
                case Position.left:
                    _config.position = 'left';
                    break;
                case Position.right:
                    _config.position = 'right';
                    break;
                case Position.top:
                    _config.position = 'top';
                    break;
                default:
                    _config.position = 'bottom';
            }
